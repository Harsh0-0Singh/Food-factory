        ...
        <div className="flex-1">
          ...
          <div>
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3">
              <h1 className="font-medium text-lg">(6) Search results found</h1>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[1, 2, 3, 4, 5, 6].map((restaurant: number, index: number) => (
                <Card
                  key={index}
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute top-2 left-2 bg-white/75 dark:bg-gray-700 rounded-lg py-1 px-3">
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="mt-2 flex gap-1 item-center text-gray-600 dark:text-gray-400">
                      <MapPin size={16} />
                      <p className="text-sm">
                        City:&nbsp;
                  ...
                  <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                    <Link to={`/restaurant/${123}`}>
                      <Button className="bg-orange hover:bg-hoverOrange hover:cursor-pointer font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-300">
                        View Menu
                      </Button>
                    </Link>
                  </CardFooter>
